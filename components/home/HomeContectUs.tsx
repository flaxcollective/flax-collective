      ...
      <div className="contact-container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="contact-left">
          ...
          <div className="flex justify-center md:justify-self-start gap-4 py-2 md:py-4">
            <a
              href="https://www.instagram.com/flaxcollective/"
              className=" flex items-center justify-center rounded-fulle transition group"
            >
              <FaInstagram className="text-gray-700 text-xl md:text-2xl" />
            </a>
            <a
              href="https://www.facebook.com/flaxcollective"
              className=" flex items-center justify-center rounded-full  transition group"
            >
              <FaFacebook className="text-gray-700  text-xl md:text-2xl" />
            </a>

            <a
              href="https://www.linkedin.com/company/flaxcollective"
              className=" flex items-center justify-center rounded-full  transition group"
            >
              <FaLinkedin className="text-gray-700 text-xl md:text-2xl" />
            </a>

          </div>

          <div className="py-4">
            <h3 className="text-sm md:text-2xl text-dark font-medium mb-3 md:mb-6">
              Why Reach Out to Us?
            </h3>

            <ul className="space-y-3 whyitemconnect text-base font-normal text-dark">
              <li className="flex items-center gap-2 md:gap-4">
                <GoCheckCircleFill className="text-navy text-xs md:text-2xl" />
        ...
        <div className="contact-right">
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className=" bg-[#2F3E56] p-6 md:p-8 rounded-2xl shadow-xl text-white">
              ...
              <label className="text-white text-xs md:text-sm font-medium">Your Full Name</label>
              <input
                name="name"
                type="text"
                placeholder="Name"
              ...
              {/* Email */}
              <label className="text-white text-xs md:text-sm font-medium">Email Id</label>
              <input
                name="email"
                type="email"
                ...
                className="w-full p-3 rounded-lg bg-white/10 placeholder-gray-300 border border-white/20 focus:outline-none focus:ring-2 focus:ring-white text-white"
              />
              <label className="text-white text-xs md:text-sm font-medium">Phone Number</label>
              <div className="flex  gap-2">
                <div className="select-wrapper ">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-[110px] p-4 pr-8 rounded-lg bg-[#2F3E56] text-white border border-white focus:outline-none"
                  >
                    {countries?.length ? (
              ...
              <div className="select-wrapper">
                <select
                  ...
                  className="w-full p-3 rounded-lg text-white border border-white focus:outline-none"
                >
                  <option value="" className="text-black">Choose The Service (Optional)</option>
                  <option value="Certification Programs" className="text-black">
                    For Student Certification Programs
                  </option>
                  <option value="Recruitment Services" className="text-black">
                    For Employees Recruitment Services
                  </option>
