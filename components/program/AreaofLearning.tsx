                ...
                <div className="cp-section max-w-7xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <div className="cp-areas-grid">
                        ...
                        <div className="cp-area-card">
                            ...
                            <p className="cp-area-label">Industry Exposure</p>
                        </div>
                        ...
                        <div className="cp-area-card">
                            ...
                            <p className="cp-area-label">Practical Learning</p>
                        </div>
                        ...
                        <div className="cp-area-card">
                            ...
                            <p className="cp-area-label">Career Readiness</p>
                        </div>
                        ...
                        <div className="cp-area-card">
                            ...
                            <p className="cp-area-label">Professional Growth</p>
                        </div>
                        ...
                        <div className="cp-area-card">
                            ...
                            <p className="cp-area-label">Community & Connections</p>
                        </div>
                    </div>
