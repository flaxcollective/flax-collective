...
const PrivacyPolicyContent = () => {
  return (
    <>
      ...
      <p className="text-xs text-text-body md:text-base leading-5 md:leading-6.5 font-medium">
      ...
      <LegalSection title="Information We Collect">
        ...
        <div className="mb-5">
          <p className="text-lg md:text-2xl font-medium text-navy mt-7.5">A-  Information You Provide Directly:</p>
        </div>
        <LegalList
          items={[
            <>
        ...
        />
        <div className="mb-5">
          <p className="text-lg md:text-2xl font-medium text-navy mt-7.5">B-  Information We Collect Automatically</p>
        </div>
        <LegalList
          items={[
            <>
        ...
        <div className="mb-5">
          <p className="text-lg md:text-2xl font-medium text-navy mt-7.5">C-  Information from Third Parties</p>
        </div>
        <LegalList
          items={[
      ...
      <LegalSection title="How We Use Your Information">
        <p className="text-lg md:text-2xl font-medium text-navy mt-8">We use your information to:</p>
        <LegalList
          items={[
      ...
      <LegalSection title="International Data Transfers">
        <p class="text-base text-text-body leading-6.5">As Flax Collective connects candidates with employers across multiple countries, your information may be transferred to and processed in jurisdictions other than your country of residence. We take reasonable steps to ensure that such transfers are conducted in line with applicable data protection requirements and that your information remains protected.</p>
      ...
      <LegalSection title="Your Rights">
        ...
        <p className="text-base text-text-body leading-6.5" >To exercise any of these rights, please contact us at <strong>info@flaxcollective.com</strong>. We may verify your identity before processing your request.</p>
      </LegalSection>
      ...
      <LegalSection title="Data Security">
        <p className="text-base text-text-body leading-6.5">
        ...
        <p className="text-base text-text-body leading-6.5">However, no method of transmission over the internet or electronic storage is fully secure. While we strive to protect your information, we cannot guarantee absolute security.</p>
      </LegalSection>
      ...
      <LegalSection title="Third-Party Links">
        <p className="text-base text-text-body leading-6.5text-base text-text-body leading-6.5">
      ...
      <LegalSection title="Updates to This Policy">
        ...
        <p className="text-base text-text-body leading-6.5">Continued use of our services after the updated Policy is published constitutes acceptance of the revised terms.</p>
      </LegalSection>
      ...
      <LegalSection title="Contact Us">
        ...
        <p className="text-base text-text-body leading-6.5">Flax Collective <strong> Email: info@flaxcollective.com</strong></p>
